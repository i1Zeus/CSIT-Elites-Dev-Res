        ...
        <div class="m-5">
          ...
          >
            ...
            <path
              ...
              fill="#63ffa5"
            />
            <circle cx="253.81624" cy="156.61796" r="13.08937" fill="#63ffa5" />
            <path
...
export default {
  ...
  setup(props) {
    ...
    fetch("http://127.0.0.1:8000/api/resources/update/" + props.id, {
      method: "POST",
      headers: {
    ...
    return { latestR, error, toogleModal, handleSubmit, name, description };
  },
};
</script>
