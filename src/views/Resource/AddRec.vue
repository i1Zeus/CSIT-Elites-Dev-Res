          ...
          <div class="divide-y divide-gray-200">
            <div class="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
              ...
              <div class="flex flex-col">
                ...
                <input @keydown.enter.prevent="addLink" v-model="link" type="text"
                  class="px-4 py-2 border focus:ring-gray-500 focus:border-gray-900 w-full sm:text-sm border-gray-300 rounded-md focus:outline-none text-gray-600"
                  placeholder="Add a Link" />
              </div>
              <div v-for="link in links" :key="link" class="flex flex-row-reverse items-center justify-between">
                <button class="font-bold text-gray-500 hover:text-red-500" @click="deleteLink(link)">
                  <font-awesome-icon icon="fa-solid fa-xmark" size="lg" class="px-1" />
                </button>
              ...
              <div class="flex gap-14">
                <div class="flex flex-col gap-1">
                  ...
                  <input @keydown.enter.prevent="addTags" v-model="tag" type="text"
                    class="px-4 py-2 border focus:ring-gray-500 focus:border-gray-900 w-full sm:text-sm border-gray-300 rounded-md focus:outline-none text-gray-600"
                    placeholder="Add Tags" />
                  <div v-for="tag in tags" :key="tag" class="flex flex-row items-center justify-between">
                    <p class="w-full items-baseline bg-gray-100 px-2 rounded-lg">
                      #{{ tag }}
                    </p>
              ...
              <div class="flex flex-col">
                ...
                <textarea required v-model="description" type="text"
                  class="px-4 py-2 border focus:ring-gray-500 focus:border-gray-900 w-full sm:text-sm border-gray-300 rounded-md focus:outline-none text-gray-600"
                  placeholder="Remember to add a description"></textarea>
              </div>
            </div>
            <div class="pt-4 flex items-center space-x-4">
              ...
              <button v-else v-on:click="add()" type="submit"
